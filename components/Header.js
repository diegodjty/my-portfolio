            ...
            {/* Nav */}
             <nav className='w-full text-center mt-24'>
                 <ul className='flex flex-col'>
                    <li className='list-item border-t border-blue-light'><a href='#aboutme'  >About Me</a></li>
                     <li className='list-item'><a href='#skills'  >My Skills</a></li>
                     <li className='list-item'><a href='#portfolio'  >My Portfolio</a></li>
                     <li className='list-item'><a href='#contactme'  >Contact Me</a></li>
                 </ul>
             </nav>
