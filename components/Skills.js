...
function Skills() {
  ...
  return (
    <div
      ref={ref}
      id="skills"
      className="bg-blue-dark max-w-[90%] m-auto lg:h-screen 2xl:flex 2xl:flex-col 2xl:justify-center md:mb-40"
    >
      <motion.div
        animate={animation2}
        initial={{ x: '-100vw' }}
        className="mt-16 mb-5 2xl:w-[60%]"
      >
        <h2 className="text-2xl text-yellow font-bold lg:text-6xl lg:mb-10">
          My Skills
        </h2>
        <p className="text-white mt-2 lg:text-lg">
          Here is a list of some of the skills I have learned over the years,
          some self-taught, and others learned in college.
        </p>
      </motion.div>
      <motion.div
        animate={animation}
